...
public class CustomPorxy {
    ...
    public static Object newProxyInstance(CustomClassLoader classLoader, Class<?>[] interfaces, CustomInvocationHandler h) {
        ...
        try {
            ...
            String filePath = CustomPorxy.class.getResource("").getPath();
    ...
    private static String generateSource(Class<?> interfaces) {
        ...
        src.append("package com.aias.demo.custom;" + ln);
        src.append("import java.lang.reflect.Method;" + ln);
        src.append("public class $Proxy0 implements " + interfaces.getName() + "{" + ln);

        src.append("CustomInvocationHandler h;" + ln);
